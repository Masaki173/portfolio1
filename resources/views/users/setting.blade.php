...
<form action="update" method ="post" enctype="multipart/form-data" class="user-detail">
  ...
  <div class="change-name"><input type="text" name="name" placeholder="名前を変更しましょう"></textarea></div>
  <div class="write-profile"><textarea name="profile" placeholder="自己紹介を書きましょう"></textarea></div>
