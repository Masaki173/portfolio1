...
<form action="store" method ="post" autocomplete="off" class="create-content">
 ...
 @enderror
  ...
  <tr><th><input type="text"  name="title" placeholder="記事のタイトルを書きましょう" style="height:35px; width:500px; font-size: 60%;"></input></th>
   <tr><td>
   @error('content')
 <tr><td>Error:{{$message}}</td></tr>
 @enderror
...
<label>￥<input type="tel" class="priceForm" minlength="3" name="price" value="100" style="height:30px; font-size: 60%;"></input> JPY</label>
</td></tr>
<tr><td>
</span>
